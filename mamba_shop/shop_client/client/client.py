...
@app.route('/<username>/orderConfirm.html')
def orderConfirm(username):
    #订单信息
...
@app.route('/<username>/payment.html')
def payment(username):
    #订单信息
    return send_file('templates/payment.html')

@app.route('/<username>/pay_success.html')
def pay_success(username):
    #订单信息
    return send_file('templates/pay_success.html')

@app.route('/findPass.html')
def findPass():
    #找回密码
    return send_file('templates/findPass.html')

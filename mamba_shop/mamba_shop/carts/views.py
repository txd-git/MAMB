...
class CartsView(View):
    ...
    def del_carts_data(self, user_id, sku_id):
        ...
        data = redis_c.get(key)
        del data[sku_id]
        redis_c.set(key, data)
